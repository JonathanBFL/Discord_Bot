...
const {roleIdHasNot} = require("./hasnotreadrulesrole.json");
...
function Interaction(client) {
    ...
    try {
        ...
        client.on('interactionCreate', async interaction => {
            ...
            if (interaction.isButton()) {
                ...
                //print they agreed
                    ...
                    //todo: cleanup
                    //removes has not read rules role
                    interaction.member.roles.remove(roleIdHasNot);
            ...
            //looks for new member role command
            if (commandName === 'hasnotreadrulesrole') {
        ...
        console.log('!!!!! error occured in interaction.js !!!!!');
